...
$(document).ready(function () {
    ...
    // this is for memory card aceesories filter 
    $("#mcard_filter").on("change", function () {
        let selected = $(this).val().toLowerCase().trim();
        $("#memory_filter_cards .card").each(function () {
    ...
    // this is for tripod  aceesories filter 
    $("#tripod_filter").on("change", function () {
        let selected = $(this).val().toLowerCase().trim();
        $("#tripod_filter_cards .card").each(function () {
            let brand = $(this).data("brand")?.toLowerCase().trim();
    ...
    // this is for camera bags and cases  aceesories filter 
    $("#bag_filter").on("change", function () {
        let selected = $(this).val().toLowerCase().trim();
        $("#bag_filter_cards .card").each(function () {
            let brand = $(this).data("brand")?.toLowerCase().trim();
